...
public class AddAddressBook {
	...
	public int addAddress(int i) {
		...
		//WebElement birthDate = (WebElement) driver.findElements(By.id("address_birthday"));
	...
	/*		
		List<WebElement> allDates = driver.findElements(By.name("address[birthday]"));
